#here HIGH LOW hote rehti activity ki value

# import cv2
# from ultralytics import YOLO

# # Load the YOLO model
# model = YOLO('dogattack2.pt')

# # Define label names
# LABELS = {0: 'Animal', 1: 'Person'}  # Update as per your labels
...
#     activity = "low"  # Default activity level
#     animal_boxes = []
#     person_boxes = []
...
#             # Store bounding boxes for animals and persons
#             if cls == 0:  # Animal
#                 animal_boxes.append((x1, y1, x2, y2))
#             elif cls == 1:  # Person
#                 person_boxes.append((x1, y1, x2, y2))

#     # Check for overlap between animals and persons
#     for animal_box in animal_boxes:
#         for person_box in person_boxes:
#             if check_overlap(animal_box, person_box):
#                 activity = "high"
#                 break

#     # Display activity level on the frame
#     cv2.putText(frame, f'Activity: {activity}', (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)

#     return frame

# # Input video file path
# video_path = 'C:\\Affan\\Affan\\__S.I.H. 2k24__\\HackRev 2025\\WasteManagement Predictor\\input\\animal_attack.mp4'  # Replace with your video file path
...
# # Output video writer
# output_path = 'C:\\Affan\\Affan\\__S.I.H. 2k24__\\HackRev 2025\\WasteManagement Predictor\\output\\dogattack3.mp4'
...
def send_sms():
    try:
        message = client.messages.create(
            body="Alert: High activity detected! A person is being attacked by animals...Please take necessary actions!!",
